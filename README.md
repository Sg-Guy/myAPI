...
Installation
    Cloner le dépôt : git clone https://github.com/Sg-Guy/myAPI
...
Pour générer et visualiser la documentation :
...
Visualiser la documentation dans le navigateur :
    ...
    Tous les endpoints, paramètres et réponses sont détaillés.
    Les requêtes POST, PUT et DELETE sont testables directement depuis Swagger UI.
...
Tests
Utiliser Postman ou Insomnia ou la documentation directe (UI swagger) pour tester les endpoints.
